...
def plot_forecast(
    ...
    with plt.style.context("dark_background"):
        ...
        if save:
            target_dir = output_dir or FORECASTS_DIR
            target_dir.mkdir(parents=True, exist_ok=True)
            out_path = target_dir / f"{host_alias}_{metric}_lags{n_lags}_forecast.png"
...
def plot_overview(
    ...
    with plt.style.context("dark_background"):
        ...
        if save:
            target_dir = output_dir or FORECASTS_DIR
            target_dir.mkdir(parents=True, exist_ok=True)
            out_path = target_dir / f"{host_alias}_overview_lags{n_lags}.png"
            fig.savefig(out_path, dpi=_DPI, bbox_inches="tight", facecolor=fig.get_facecolor())
